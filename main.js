        ...
        for(var i = 0; i < radioButtons.length; i++)
        {
            ...
            {console.log(radioButtons[i].value)
                if(radioButtons[i].value=="Glasses"){
                    image(dwiimg,nose_x-50,nose_y-65,150,100);
                }
                if(radioButtons[i].value=="clownnose"){
                    image(noseimg,nose_x-5,nose_y-20,60,50);
                }
                if(radioButtons[i].value=="moustache"){
                    image(mimg,nose_x-25,nose_y,100,50);
                }
                if(radioButtons[i].value=="crown"){
                    image(crownimg,nose_x-75,nose_y-200,200,150);
                }
            }
        }
}    
